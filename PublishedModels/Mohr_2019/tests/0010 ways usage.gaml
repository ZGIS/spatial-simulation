...
global {
	...
	int number_of_touringcompanys <- 100;						// number of paralell touringcompanys
...
species ways  {
	...
	aspect base {
		...
		draw  string(tc_on_way with_precision 2) + " | " + string(sum_tc_on_way  with_precision 2) font:font('',12,#none) color: #black;
	}
}
