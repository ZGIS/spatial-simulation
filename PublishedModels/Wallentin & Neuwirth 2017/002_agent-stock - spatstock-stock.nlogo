...
to go
  ...
  if ABM-mode? = FALSE [
    ...
    ;; diffusion not possible with conveyor stock
...
to-report biomass-removed
  report ( plankton-eaten + sum [fish-stock-sd] of lake-patches * 0.0000027
  ) * dt
end
...
This is Design 2 of a series of six hybrid model designs.
