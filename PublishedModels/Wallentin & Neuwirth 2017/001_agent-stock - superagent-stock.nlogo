...
to-report biomass-removed
  report ((count fish + sum [fish-stock] of schools) * 0.0000027 * dt)
end
...
This is Design 1 of a series of six hybrid model designs.
